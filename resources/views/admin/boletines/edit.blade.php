        ...
        <form action="{{ route('admin.boletines.update', $boletin) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                ...
                <textarea id="descripcion" name="descripcion" rows="4"
                          class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#00839B] focus:border-[#00839B] transition">{{ old('descripcion', $boletin->descripcion) }}</textarea>
